...
private extension OperationKind {
    var errorCodeComponent: String {
        ...
        case .branchRename: "BRANCH-RENAME"
        case .branchDelete: "BRANCH-DELETE"
        case .branchUpstream: "BRANCH-UPSTREAM"
        case .branchCleanup: "BRANCH-CLEANUP"
        case .tagCreate: "TAG-CREATE"
        case .tagDelete: "TAG-DELETE"
        case .tagPush: "TAG-PUSH"
        case .remoteAdd: "REMOTE-ADD"
        case .remoteEdit: "REMOTE-EDIT"
        case .remoteDelete: "REMOTE-DELETE"
        case .remoteFetch: "REMOTE-FETCH"
        case .reflogRestore: "REFLOG-RESTORE"
        case .cherryPick: "CHERRY-PICK"
        case .revertCommit: "REVERT"
        case .resetCommit: "RESET"
        case .rewriteCommit: "REWRITE-COMMIT"
        case .reorderCommits: "REORDER-COMMITS"
        }
    }
    ...
    var errorOperationKey: String {
        ...
        case .compare: "error.operation.compare"
        case .branchCreate: "error.operation.branch_create"
        case .branchRename: "error.operation.branch_rename"
        case .branchDelete: "error.operation.branch_delete"
        case .branchUpstream: "error.operation.branch_upstream"
        case .branchCleanup: "error.operation.branch_cleanup"
        case .tagCreate: "error.operation.tag_create"
        case .tagDelete: "error.operation.tag_delete"
        case .tagPush: "error.operation.tag_push"
        case .remoteAdd: "error.operation.remote_add"
        case .remoteEdit: "error.operation.remote_edit"
        case .remoteDelete: "error.operation.remote_delete"
        case .remoteFetch: "error.operation.remote_fetch"
        case .reflogRestore: "error.operation.reflog_restore"
        case .cherryPick: "error.operation.cherry_pick"
        case .revertCommit: "error.operation.revert_commit"
        case .resetCommit: "error.operation.reset_commit"
        case .rewriteCommit: "error.operation.rewrite_commit"
