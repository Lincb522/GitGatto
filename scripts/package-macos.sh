...
DEFAULT_SPARKLE_PUBLIC_KEY="$(/usr/libexec/PlistBuddy -c 'Print :SUPublicEDKey' "$ROOT/Config/GitGatto-Info.plist")"
SPARKLE_PUBLIC_KEY="${GITGATTO_SPARKLE_PUBLIC_KEY:-$DEFAULT_SPARKLE_PUBLIC_KEY}"
